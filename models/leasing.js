...
var LeasingSchema = new Schema({
  kodeLeasing: {type : String, default : '', trim : true, unique: true},
  tipeLeasing: {type : String, default : '', trim : true},
...
mongoose.model('Leasing', LeasingSchema)
